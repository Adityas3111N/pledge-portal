  ...
  return (
    <main className="w-full min-h-screen bg-white font-sans">
      <div className="w-full min-h-screen relative overflow-hidden bg-white">
        ...
        >
          <Image 
            src="/assets/backgrounds/department_login_bg.png" 
        ...
        <div className="relative z-10 w-full min-h-screen grid grid-cols-1 lg:grid-cols-[40%_60%]">
          ...
          <div className="hidden lg:flex relative w-full h-full bg-transparent flex-col items-center justify-start pt-[110px] overflow-hidden">
            ...
            >
              <Image src="/assets/logos/upgovlogo.png" alt="UP Gov Logo" width={90} height={90} className="object-contain" />
              <div className="flex flex-col gap-4">
                <h2 
                  className="font-poppins font-semibold text-[22px] leading-[30px] text-neutral-dark"
            ...
            <div className="w-full max-w-[491px] flex flex-col gap-[40px] mt-4 lg:mt-0">
              <div className="w-full flex flex-col gap-[12px] text-center px-2">
                <h1 className="font-poppins font-medium text-[24px] min-[375px]:text-[28px] sm:text-[40px] leading-[1.2] text-neutral-dark tracking-tight whitespace-nowrap mx-auto">
                  <span className="text-brand-orange-bright">{t("login.departmentLog")}</span> {t("login.inHere")}
                </h1>
